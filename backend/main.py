...
from backend.core.revision_agents import DynamicRevisionAgent  # Changed from ProgressiveRevisionAgent
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        revision_agent = DynamicRevisionAgent(llm_wrapper, mongodb_client)  # Changed from ProgressiveRevisionAgent
