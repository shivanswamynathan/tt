...
class SessionState(BaseModel):
    ...
    # Original fields for enhanced revision flow
    current_chunk_index: int = 0
    revision_mode: Optional[str] = None  # "quick_recap" or "deep_dive"
    ...
    # NEW FIELDS for DynamicRevisionAgent
...
class RevisionSessionData(BaseModel):
    ...
    # NEW FIELDS for dynamic tracking
    quiz_frequency: int = 5
    concepts_learned: List[str] = []
    quiz_scores: List[float] = []
    needs_remedial: bool = False
